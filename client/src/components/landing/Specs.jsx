...
function Specs() {
    ...
    const specs = [{
        ...
        title: 'Oxford 3000 Kelime',
        desc: 'Oxford 3000 kelime listesi ile en sık kullanılan İngilizce kelimeleri öğrenin ve bu kelimelerden dilediğinizi kendi kelime listenize ekleyin. Bu kelimeler, dil öğrenim sürecinizde size büyük bir avantaj sağlayacaktır.',
        icon: 'menu-book',
    }]
